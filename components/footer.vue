<template>
    ...
    <div class="grid grid-cols-5 grid-rows-5 bg-navy-blue-50 h-96">
        ...
        <div class="flex flex-col justify-start items-end row-span-4 col-start-5 border-black border-l border-t-2 border-r-2  pr-10 pt-10 border-b">
            ...
            <NuxtLink>USER GENERATED CONTENT</NuxtLink>
            <NuxtLink>INFLUENCER MARKETING</NuxtLink>
            <NuxtLink class="mb-0 ">VOLUMETHREESTUDIOS@GMAIL.COM</NuxtLink>
        </div>
        <div class="col-span-3 col-start-2 row-start-5 border-black border-t border-x border-b-2">14</div>
        <div class="col-start-1 row-start-5 border-black border-t border-r border-b-2 border-l-2">15</div>
